...
const LiveDashboard = () => {
  ...
  useEffect(() => {
    const fetchPrices = async () => {
      ...
      const tips = [];
      if (result.BTC > 1200000)
        tips.push("📈 BTC yüksek, kâr realizasyonu düşünebilirsin.");
      if (result.ETH < 30000)
        tips.push("📉 ETH düşüşte, alım fırsatı olabilir.");
      if (result.USD > 40)
        tips.push("📈 Dolar kuru yükseliyor, döviz pozisyonu korunabilir.");
